...
import 'package:myapp/controller/retailer_order_load_controller.dart';
import 'package:myapp/controller/retrailer_controller.dart';
import 'package:myapp/widgets/our_elevated_button.dart';
import 'package:myapp/widgets/our_retailer_order_card.dart';
...
class RetailerOrderLoad extends StatefulWidget {
  RetailerOrderLoad({Key? key}) : super(key: key);

  @override
  State<RetailerOrderLoad> createState() => _RetailerOrderLoadState();
}

class _RetailerOrderLoadState extends State<RetailerOrderLoad> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FlutterDropdownSearch(
                          ...
                          items:
                              Get.find<RetrailerController>().retrailernameList,
                          dropdownHeight: 300,
                        ),
                        OurSizedBox(),
                        Row(
                          ...
                          child: OurElevatedButton(
                            ...
                            function: () async {
                              ...
                              addProductModelList.forEach((element) {
                                itemListJson.add(element.toRetailerMap());
                                // print(element.toMap());
                              });
                              print(itemListJson);
                              ...
                              index = Get.find<RetrailerController>()
                                  .retrailernameList
                                  .indexOf(
                                    _retailer_name_controller.text.trim(),
                                  );
                              print(index);
                              id = Get.find<RetrailerController>()
                                  .retrailerIDList[index];
                              partyRetailerId = id;
                              Map<String, dynamic> toJson = {
                                "orderDate": _order_date.text.trim(),
                                "retailer": partyRetailerId,
                                "deliveryDate": _delivery_date.text.trim(),
                                "products": itemListJson,
                              };
                              if (_distributer_name_controller.text.trim() ==
                                      "" ||
                                  _retailer_name_controller.text.trim() == "" ||
                                  addProductModelList.isEmpty) {
                                OurToast().showErrorToast("Enter Data");
                              } else {
                                print(toJson);
                                print(partyDistributerId);
                                await APIService().addRetailerOrder(
                                    toJson, partyDistributerId, context);
                              }
                            },
                          ),
                        )
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              StreamBuilder(
                stream: RetailerOrderController.getVisitPlan(),
                        ...
                        ? searchText.trim().isEmpty
                            ? AnimationLimiter(
                                ...
                                itemBuilder: (BuildContext context, index) {
                                  Retailerlistdata data = snapshot.data[index];
                                  return AnimationConfiguration.staggeredList(
                                    ...
                                    child: SlideAnimation(
                                      ...
                                      child: FadeInAnimation(
                                        child: OurRetailerOrderCard(data: data),
                                      ),
                                    ),
                                  );
                                  // return OurRetailerOrderCard(data: data);
                                },
                              ))
                            : AnimationLimiter(
                                child: ListView.builder(
