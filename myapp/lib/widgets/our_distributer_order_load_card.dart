...
class OurDistribterOrderLoadCard extends StatelessWidget {
  final DistributerorderloadData data;
  const OurDistribterOrderLoadCard({Key? key, required this.data}) : super(key: key);
